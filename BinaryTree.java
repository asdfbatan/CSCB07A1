...
public class BinaryTree {
	...
	/*
	 * This function return back a textual representation of the binary tree
	 * The textual representation of the binary tree is returning back a string 
	 * such that the string contains all the ints of the binary tree level by level 
	...
	public String toString()
	{
		...
		return output; //added this to remove the compile time error in starter code. 
	}
	

	/*
	 * This method returns back an ArrayList that contains ints
	 * i.e, the data of each of the Node of the binary tree in Inorder traversal.
	 * It inturn calls the method addSubTree.
	 */
	...
	/*
	 * This method use recursion to populate the ArrayList using inOrder traversal of the tree.
	 */
